...
这种分类是从技术基础到行业应用的思维。它是商业导向的，不是个人实践导向的。实践过程中会有几个问题
...
新分类按照实践导向进行分类。意在提高投入产出转化。其中，将旧有的技术夯实部分转化为内部设计方案。
...
- 应用技术：综合技术、学习物联网（`路径缺失`）
  ...
  - [ ] GUI：
    - [thorvg-zig-example](https://github.com/SuperAuguste/thorvg-zig-example)
- 人工智能技术
  - [ ] 学习 Pytorch
  - [ ] 学习案例（目标分类、目标检测、语义分割）
  - [ ] 语音转文本
    ...
    - Webrtcvad：静音检测
  - [ ] [小程序音视频通话 SDK (Linux 设备)](https://developers.weixin.qq.com/miniprogram/dev/framework/device/voip/voip-sdk.html)
- 机器人
  - OpenIPC
...
- [TileMill](https://live.osgeo.org/archive/10.5/zh/overview/tilemill_overview.html)：[tilemill](https://github.com/tilemill-project/tilemill)
...
- [ ] MES 生产管理系统
- [ ] [AnimatedGallery](https://github.com/SimonAKing/AnimatedGallery)



## 其他技术

- [ ] [Coding Without a Laptop](https://holdtherobot.com/blog/2025/05/11/linux-on-android-with-ar-glasses/)



### 已启动未完成项目

FOC电机、压力传感器、超声波传感器（ESP摄像头）、磁悬浮、POE