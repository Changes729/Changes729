> 文章来源：https://ssir.org/books/excerpts/entry/no_straight_lines_making_sense_of_our_non-linear_world
>
> 议题：Health 健康
...
By [Alan Moore](https://ssir.org/books/excerpts/entry/no_straight_lines_making_sense_of_our_non-linear_world#bio-footer) Sep. 11, 2012
...
以下案例的共同点是什么？一家以全球社区为组织核心的汽车公司，通过结合柔性制造技术、开源平台、开放式法律框架和基于合作的社交通信技术，以成为一家伟大且环保的公司为愿景，它能以低于 100 倍的资本成本（capital costs）将造车速度提高 5 倍。在 2008 年肯尼亚大选后危机中诞生的危机管理平台和组织，可以通过基于位置的数据、目击者的描述及移动电话，从通常难以到达的地方记录展开事件（unfolding events）的关键信息，并将这些正在发生的事件可视化，以便其他人能够借助互联网及时采取行动并指导行动。现在，世界上许多地方都在免费使用这种技术。再者，英国最大的有机奶制品农场，他们已经形成了一种方法，使他们能够在一个剧烈波动的市场中保持自主、盈利和可持续发展，因为大规模的农业耕作主要是以石油为基础的经济，以及奶制品农场主（的定价）会因大型连锁超市的营销需求和运营想法（whimsys）的决定。
...
上面的案例共同代表了一种生活、工作和组织的新现实。所有组织或公司都在寻求更好的方式为人类服务，在自己和他人所做的工作中寻找意义，并为过去的工作方式提供新的、可行的替代方案。他们寻求一种更好分配财富、思想和资源的结果。事实上，人们可能会说，这样的结果更加人性化，更加以社区为中心。我认为这是一种迭代升级（ungrading），并称之为人类的操作系统（Human-OS）。这种操作系统希望有更多的机会、更广泛的自由、更强的能力、焕然一新的正义感、一个以互助主义和参与式文化为默认设置的世界、一个开放被视为有韧性、多样性被理解为好事的世界、一个我们拥有更大自主权的世界，以及一个在我们所做的一切中寻求更美好的世界：美观的建筑、公民空间、组织设计，让事物变得美丽和变得丑陋一样容易。那么，为什么要选择后者而不是前者呢？这个问题一直困扰着我，我只知道丑陋的思想会带来丑陋的现实。



This OS is the key driver to the systems change we are witnessing. I see this Human-OS in the transformational change of all the examples cited in No Straight Lines: from agriculture, hospital design, and healthcare service design, educational programmes, the response to complex civic challenges, manufacturing, NGO’s, the nature of finance, innovation and commerce itself. This OS is the story of why our networked world with its new Human OS is directing the shape of our post industrial future.

这种操作系统是我们正在目睹的系统性变革的关键驱动力。我在《没有直线》一书中列举的所有例子的变革中都看到了这种人类操作系统：从农业、医院设计、医疗保健服务设计、教育计划、应对复杂的公民挑战、制造业、非政府组织、金融的本质、创新和商业本身。这个操作系统讲述了为什么我们的网络世界及新的人类操作系统正在引导我们后工业时代的未来。



Rather than premised upon the extraction of wealth, and resources, whether they be physical, mineral or otherwise, these very different initiatives represent both moral courage and a collective purpose, if you will. And why is that important? Because it does not matter if you are an employer, a worker, VC fund, an NGO, an organisation, a local council or a government, you will miss out on the energies and capabilities of your people who will increasingly seek those new realities to discover a better way of living, working and being, when better and viable alternatives are on offer. And the fact is we now have the possibility to truly transform our world, to be more lightweight, sustainable and humane, through the tools, capabilities, language and processes at our fingertips. As Tony Judt argued, ‘why do we experience such difficulty even imaging a different sort of society? Why is it beyond us to conceive a different set of arrangements to our common advantage?’

这些迥然不同的倡议并不是以攫取财富和资源（无论是实物、矿产还是其他资源）为前提，而是代表着道德勇气和集体目标。为什么这很重要？因为不管你是雇主、工人、风险投资基金、非政府组织、机构、地方议会还是政府，你都会错过人民的能量和能力，当有更好、更可行的选择时，他们会越来越多地寻求这些新的现实，以发现更好的生活、工作和生存方式。而事实是，我们现在有可能通过唾手可得的工具、能力、语言和程序，真正改变我们的世界，使之更加轻盈、可持续和人性化。正如托尼·朱特（Tony Judt）所言，“为什么我们连想象一个与众不同的社会都如此困难？为什么我们无法为共同利益构想一套截然不同的制度安排？”
...
这就引出了本项目的标题和挑战——《脚踏实地，想象不可能（Be realistic, imagine the impossible）》取自 1968 年巴黎骚乱（五月运动）的一张海报。在理解它对我们这个时代的意义时，我认为我们在工业社会末期所面临的是一个设计问题。原因在于，我们目睹了许多曾为我们带来繁荣的机构陷入系统性失灵，而正是这种多重失灵的叠加要求我们从整体系统的角度来理解眼前的挑战。
...
我们仍在沿用的许多机构、组织和系统都是为一个不那么复杂的世界设计和建造的，我们世界复杂性的增加给这些机构、组织和系统带来了不可持续的负担。换言之，我们的工业世界已经达到了其适应范围的边缘。因此，在我们的社会中出现了一些断层，这些断层围绕着相互交织的社会、经济和组织张力和问题，形成了一个三难困境。解决这些问题所涉及的设计挑战，是因为非线性变化正在引起整个社会的全面重组，打破旧的组织模式，而三重困境则预示着不确定时代的到来。这三种矛盾都在变化之中，如果不统筹考虑其他两种矛盾，任何一方都无法得到妥善解决。因此，该叙事的每一部分都反映并关联着这一三重困境：个人与公司及其他组织和权力形式之间在经济、社会和政治方面的关系。

![img](https://ssir.org/images/jcogs_img/cache/chart_no_straight_lines_-_abcdef_-_ec76adfb59d23efa05b4d7ecdd5601e6950c9f26.webp)
...
现在，当我们面对一个在很短的时间内从看似线性（简单）变得复杂和非线性（混乱）的世界时，我们需要一种方法来评估未来的走向。当我们进入一个本质上更加复杂的世界时，结果是令人震惊的，其迷失方向的影响包围着我们，而且我们个人或组织层面的反应可能会导致一些危险的、具有腐蚀性或不恰当的本能反应和观点。然而，这种混乱似乎正在加速蔓延。此时此刻，大辩论正在激烈进行。9-11事件（我们现在谈论的是非对称战争）和世界银行体系的濒临崩溃（及其对我们每个人的非对称影响）都在影响着我们。而且，随着全球经济重心东移，引发了一系列事件，对世界各地的社会产生了重大的非对称经济影响。以上只是三个例子，说明意识形态或其他方面的断层正在同时爆发和内缩。它们在短短十年内相继出现。不过更值得注意的是，它们的酝酿期更长，而且本质上是多维度的。这些挑战高度关联、相互依存，因此，“一刀切 ”的对策是行不通的。我们面临的不再是简单的问题，而是复杂世界的三重困境。本书将尽力面对这些问题，因为我们面临的不仅仅是经济危机，同样还有政治、教育、精神和道德危机。
...
我们面临的最大挑战是文化挑战。我们如何看待（理解）周围的世界，决定了我们如何参与和采取何种行动。然后，这些行动决定了我们必须接受的结果，这就要求我们改变工业思维和行为，转而更加深刻的认识到现在被视为非线性的世界。在这里，我想回到一个观点：即我们所面临的是设计问题，答案并不存在于高不可攀的理论层面，而是存在于我们工厂的车间、城镇的街道、学校的课堂、医院的候诊室。这些答案将体现为真正的创造行为，通过我们集体做出的决定，创造出完成工作的新方法。因此，在重新设计世界的过程中，我们需要人类在动手实践中的创造力，我们需要能带来实质性改变的高瞻远瞩的领导力。我们需要工匠的批判性眼光、稳健的双手和创造性思维。正是这种 “洞察 ”的过程——通过将两个 “不相关”（新信息、工具、流程等）紧密结合在一起，实现通往成功的新途径——让我们创造和制造新事物。然后，我们才能有意义地应用这种能力。
...
为什么工匠精神的理念在这个时代具有重要意义？因为这关系到我们未来的塑造，而 “参与其中 ”的工匠会将人类的全部力量都投入到他的工作中。他的手由他的眼睛引导，由他的创造性思维提供信息；他的生产力是独特的创造行为。事实上，工匠大师善于利用哲学框架以及工具和材料，为世界带来有用的东西。但不仅如此，工匠还必须不断接受新思想；从本质上讲，他始终处于测试阶段。因此，我们不能只用线性和呆板的正统逻辑来应对我们这个不确定的非线性世界。工匠的批判性眼光和创造性思维对于评估新的可能性至关重要；他必须对新的想法、信息、工具和材料持开放态度，才能制造出让人类繁荣的事物。这种方法从本质上讲更具创造性，因为它融合了各个方面使我们真正成为人类。游戏设计师是工匠，Linux 程序员是工匠，第 3 章和第 8 章将详细讨论的 Local Motors 和 Ushahidi 等创新组织将工匠精神融入他们所做的一切。这些都是精心设计的应对措施，解决了以前现实生活中被认为像《第二十二条军规（Catch22）》中的情节一样难以解决的问题。
...
因此，我怀着一个坚定的信念来参与这个项目，那就是我们有机会为当今许多看似棘手的问题带来一种思维方式。但是，这需要我们像工匠一样思考和行动，运用我们的批判性思维来理解我们的非线性世界，这个世界在一定程度上是由参与性文化、开放、复杂和看似模棱两可的系统所塑造的，而这些系统又是高度相互依存的。我们需要被激发出史诗般的热情，寻求史诗般的胜利，做出明智的选择，共同创新出新的可能，从而使人类的生活不再受制于工业时代思维的压迫性现实，而是围绕人类的主要需求而设计。我们需要探索我们的非线性世界，而不是剥削它。
...
我相信有很多证据证明了这种社会的可能性。它存在于哲学框架、语言和文化素养、法律框架、工具和技术中，也存在于他人如何被真正的愿望所激励，去创造新的、更好的答案来解决他人称之为无法解决的问题的真实故事中。我的使命就是将这些独立的组成部分整合在一起，为你们提供一个既现实又极有可能实现的世界愿景。但是，要创建这个再生社会，我们就必须像普鲁斯特所说的那样，踏上探索之旅，用全新的眼光来审视这个世界。这是一个没有直线的世界，而本项目就是我们如何理解这个非线性世界，并在其中采取行动。
...
![img](http://www.ssireview.org/images/articles/Alan_Moore_headshot.jpg)

**Alan Moore**is author of*Communities Dominate Brands: Business and Marketing Challenges for the 21st Century*and founder of the innovation company Small Medium Large XtraLarge Ltd. (SMLXL).

**艾伦-摩尔（Alan Moore）**是《社区主宰品牌》（*Communities Dominate Brands： 21世纪的商业和营销挑战》*的作者，也是创新公司Small Medium Large XtraLarge Ltd. (SMLXLL) 的创始人。(SMLXL) 的创始人。