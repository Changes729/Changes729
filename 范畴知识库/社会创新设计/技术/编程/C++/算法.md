...
关键词：图的表示（[邻接链表、邻接矩阵](https://www.hello-algo.com/chapter_graph/graph/#911)、[链式前向星](https://www.bilibili.com/opus/577729382567986697)）、图搜索算法（广度优先、深度优先）、[稀疏图](https://baike.baidu.com/item/%E7%A8%80%E7%96%8F%E5%9B%BE/4273216)、[稠密图](https://en.wikipedia.org/wiki/Dense_graph)
